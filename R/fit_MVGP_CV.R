...
#' @return An object of class `stanfit` returned by `rstan::sampling` or `rstan::vb`
#'
# fits MVGP model on cross-validation data
...
fit_MVGP_CV <- function(y_train, y_test, X_train, X_test, 
  ...
  fit <- mvgp_stan(y=y_train, X=X_train, y_pred=y_test,
